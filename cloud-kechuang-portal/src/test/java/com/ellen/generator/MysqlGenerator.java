...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		String outputDir = "D:/windows/generator/code";
...
//		strategy.setTablePrefix(new String[] { "bmd_", "mp_" });// 此处可以修改为您的表前缀
		...
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.ellen.commons.base.BaseController");
