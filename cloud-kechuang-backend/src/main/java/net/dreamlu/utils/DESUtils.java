...
public class DESUtils {
	...
	public final static String encryptString(String str) {
	...
	public final static String decryptString(String str) {
		try {
	...
	public static void main(String[] args) {
		...
		System.out.println(des.encryptString("root"));
		System.out.println(des.decryptString("gTAglqCUvXc"));
	}
}
